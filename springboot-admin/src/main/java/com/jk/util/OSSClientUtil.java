...
public class OSSClientUtil {
    ...
    // accessKey
    private String accessKeyId = "LTAI4FfCYfW2bM92PV3XR444";
    private String accessKeySecret = "DHMKtilJa4bkkUHxel50iYh6GHvYgg";
    // 空间
    private String bucketName = "1905groupone";
    // 文件存储目录
